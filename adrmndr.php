    ...
    <div class="jumbotron text-center">
         ...
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-md-4">
                    <form action = "includes/adrmndrbcknd.php" method="POST">
                        <input type="text" name="genre" placeholder="Genre"><br><br>
                        <input type="text" name="note" placeholder="Note"><br><br>
                        <input type="date" name="date" placeholder="Date"><br><br>
                        <input type="time" data-date-format="DD MMMM YYYY" name="time" placeholder="time"><br><br>
                        <input type="submit" name="adrmndr" value="Add Reminder">
                    </form>
                 </div>
                 <div class="col-md-4">
